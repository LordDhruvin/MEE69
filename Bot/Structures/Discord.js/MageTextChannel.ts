...
export interface MageTextChannel extends TextChannel {
    sendCode(content?: string, language?: string, options?: MessageOptions): Promise<Message|Array<Message>>
}
...
export default Structures.extend('TextChannel', TextChannel => {
    ...
    class MageTextChannel extends TextChannel {
         ...
         */
        public async sendCode(content = '', language = '', options: MessageOptions): Promise<Message|Array<Message>> {
